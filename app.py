...
if st.button("Generate Images"):
    ...
    with col1:
        st.image(generated_images[0], use_column_width=True, clamp=True, output_format="png")
    with col2:
        st.image(generated_images[1], use_column_width=True, clamp=True, output_format="png")
    with col3:
        st.image(generated_images[2], use_column_width=True, clamp=True, output_format="png")
    with col4:
        st.image(generated_images[3], use_column_width=True, clamp=True, output_format="png")
    with col5:
        st.image(generated_images[4], use_column_width=True, clamp=True, output_format="png")
